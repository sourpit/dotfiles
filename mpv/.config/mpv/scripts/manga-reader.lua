...
function write_bookmarks()
	...
	local bookmark_file = io.open(mp.command_native({ "expand-path", opts.bookmark_path }), "w")
...
function parse_bookmarks()
	bookmark_entries = {}
	local bookmark_file = io.open(mp.command_native({ "expand-path", opts.bookmark_path }), "r")
